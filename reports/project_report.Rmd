...
Thank you for the opportunity to work with the Children's Science Center.  Below you will find a summary of our finding and recommendations.  Details of our analysis are included in the technical report that follows this summary.
...
stargazer(balance_catalyst, balance_ED, balance_catalyst_mbr, balance_ED_mbr,
          se = c(list(balance_catalyst$rse_), list(balance_ED$rse_),
                 list(balance_catalyst_mbr$rse_), list(balance_ED_mbr$rse_)), 
          type="text",
          title = "Covariate Balance",
          dep.var.labels=c("Subj: Catalyst", "From: ED", "Subj: Catalyst", "From: ED"),
...
Our design is placebo design where we can calculate CACE directly comparing the compliers, the average treatment effect (ATET). 

(WIP)

There are 23 bounce emails during the campaign. For this specific experiment, it would be more important to know the CACE (Complier Average Casual Effect) than ITT (Intended To Treat) effect. 
...
```
- Subject: ***`r round(m5.open$coefficients[[2]]*100,2)`*** percentage point [`r round(m5.open$rse.ci_[2,1]*100,1)`pp ~ `r round(m5.open$rse.ci_[2,2]*100,1)`pp]
